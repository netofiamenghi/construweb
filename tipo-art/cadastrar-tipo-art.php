...
if (isset($_POST['btnenviar'])) :
    ...
    $sql = "insert into tipo_art (tipo_descricao) values('$descricao')";
    if (mysqli_query($conexao, $sql)) :
        $_SESSION['msg'] = "<script>mostraDialogo('Tipo de ART incluído com sucesso!', 'success');</script>";
    else :
        $_SESSION['msg'] = "<script>mostraDialogo('Erro ao incluir Tipo de ART!', 'error');</script>";
    endif;
    mysqli_close($conexao);
    header("Location: cadastrar-tipo-art.php?msg=sim");
...
<body class="nav-md">
    ...
    <div class="right_col" role="main">
        <h3 class="h3">Cadastro de Tipo de ART</h3>
