...
<body class="nav-md">
    ...
    <div class="right_col" role="main">
        <h3 class="h3">Relatório de Títulos à Pagar</h3>
        <br>
        <form method="POST" action="relatorio-pagar.php" target="_blank">
            ...
            <fieldset class="col-md-12">
                ...
                <div class="col-md-1">
                    <input class="form-control" type="text" name="fornecedor" id="fornecedor" readonly />
                </div>
                <div class="col-md-6">
