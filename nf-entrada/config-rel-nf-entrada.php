...
<body class="nav-md">
    ...
    <div class="right_col" role="main">
        <h3 class="h3">Relatório de Entrada de Produtos</h3>
        <br>
        <form method="POST" action="relatorio-nf-entrada.php" target="_blank">
            ...
            <div class="col-md-6">
                ...
                <select class="form-control" name="ordem">
                    <option value="dt-emissao">DATA DE EMISSÃO</option>
                    <option value="dt-entrada">DATA DE ENTRADA</option>
                </select><br>
            </div>
