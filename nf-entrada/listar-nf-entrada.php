...
$sql = "select * from nf_entrada nf, fornecedor f where nf.nfent_fornecedor_id = f.for_id";
...
<body class="nav-md">
    ...
    <div class="right_col" role="main">
        ...
        <h3 class="h3">Lista de Entrada de Produtos</h3>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td class="text-center"><a href='cadastrar-nf-entrada.php?nf=<?= $nfent_id ?>'><span class="glyphicon glyphicon-search"></span></a></td>
                        </tr>
                <?php
                    endwhile;
                endif;
        ...
        <a class="btn btn-success" href="cadastrar-nf-entrada.php"><i class="fa fa-plus"></i> Novo</a>
    </div>
    <br />
    </div>
    <!-- /page content -->
