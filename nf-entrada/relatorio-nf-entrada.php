...
$html = "<html>
            ...
            <body>
                ...
                <span style='font-size: 16px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Relatório de Entrada de Produtos</span>
...
if ($status == 'D') :
    $where = "and nf.nfent_status = 'D' ";
elseif ($status == 'F') :
    $where = "and nf.nfent_status = 'F' ";
elseif ($status == 'C') :
    $where = "and nf.nfent_status = 'C' ";
else :
    $where = '';
endif;

if ($ordem == 'dt-emissao') :
    $order = "order by nf.nfent_dt_emissao";
else :
    $order = "order by nf.nfent_dt_lancamento";
endif;

$sql2 = "select nf.*, f.for_razaosocial from nf_entrada nf, fornecedor f where nf.nfent_fornecedor_id = f.for_id $where $order";

$resultado2 = mysqli_query($conexao, $sql2);
if ($resultado2) :
    while ($dados2 = mysqli_fetch_array($resultado2)) :
        $emissao = date('d/m/Y', strtotime($dados2['nfent_dt_emissao']));
        $entrada = date('d/m/Y', strtotime($dados2['nfent_dt_lancamento']));
        $tipo = $dados2['nfent_tipo'] == 'p' ? 'PD' : 'NF';
        $total = number_format($dados2['nfent_total'], 2, ',', '.');
        $status = $dados2['nfent_status'] == 'D' ? 'Digitada' : 'Finalizada';
        $html .= "<tr>
                 <td class='text-center'> {$dados2['nfent_numero']} </td>
