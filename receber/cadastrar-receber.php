...
if (isset($_POST['btnenviar'])) :
    ...
    $sql = "insert into receber (receber_numero, receber_sequencia, receber_cliente_id, receber_obra_id, 
            receber_dt_venc, receber_vl_orig, receber_vl_final, receber_historico, receber_status) 
            values('$numero', '$sequencia', '$cliente', '$obra', '$dtVenc','$valor', '$valor', '$historico', '$status')";
    if (mysqli_query($conexao, $sql)) :
        $_SESSION['msg'] = "<script>mostraDialogo('Título incluído com sucesso!', 'success');</script>";
    else :
        $_SESSION['msg'] = "<script>mostraDialogo('<strong>Título não incluído!</strong><br>O conjunto Número - Sequência e Cliente já existem!', 'warning', 5000);</script>";
    endif;

    header("Location: cadastrar-receber.php?msg=sim");
endif;
?>
<!doctype html>
...
<body class="nav-md">
    ...
    <div class="right_col" role="main">
        <h3 class="h3">Inclusão de Títulos à Receber</h3>
        <form method="POST" action="<?= $_SERVER['PHP_SELF'] ?>">
            ...
            <div class="col-md-12">
                ...
                <a class="btn btn-warning" href="./listar-receber.php"><i class="fa fa-reply"></i> Voltar</a>
            </div>
        </form>
        <br><br><br>
        <?php
