...
<body class="nav-md">
    ...
    <div class="right_col" role="main">
        ...
        <h3 class="h3">Lista de Títulos a Receber</h3>
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
                <?php
                $sql = "select r.*, c.cli_nome, o.obra_nome 
                        from receber r, cliente c, obra o
                        where r.receber_obra_id = o.obra_id and r.receber_cliente_id = c.cli_id
                ...
                while ($dados = mysqli_fetch_array($resultado)) :
                    ...
                    $cliente = mb_substr($dados['cli_nome'], 0, 20);
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center"><a href='alterar-receber.php?id=<?= $id ?>'><span class="glyphicon glyphicon-search"></span></a></td>
                        <td class="text-center">
                            <a class="btnPesqReceber" href="./carregar-receber.php?id=<?= $id ?>"><span class="glyphicon glyphicon-usd"></span></a>
                        </td>
        ...
        <a class="btn btn-success" href="cadastrar-receber.php"><i class="fa fa-plus"></i> Novo</a>
        <?php
        if (isset($_GET['msg'])) :
            echo $_SESSION['msg'];
        endif;
    ...
    <div class="modal fade" id="pesqReceber" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="formPagamento">
                        <form id="addRecebimento" method="POST">
                ...
                <div class="modal-footer formPagamento">
                    <button type="submit" class="btn btn-success formPagamento" name="btnsalvar" id="btnsalvar"><i class="fa fa-save"></i> Realizar Recebimento</button>
                    </form>
                    <button type="button" class="btn btn-secondary fechar-modal">Fechar</button>
                </div>

                <div class="modal-footer divPago">
                    <form id="estornarRecebimento" method="POST">
                        <input type="hidden" name="id" id="md-id" class="md-id" />
    ...
    <script src="./listar-receber.js?id=127"></script>
